...
class _PendingRequestState extends State<BuyOrderdeatil> {
 ...
 bool isLoading=false;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: (){
        refreshscreen?Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>MainScreen())):Navigator.pop(context);
      },
      child: Scaffold(
appBar: AppBar(
  ...
  elevation: 1,
  title:Text("All Orders",style: TextStyle(fontSize: 18,color: Colors.blue),) ,
),
        body: SafeArea(child:isLoading?Center(child: CircularProgressIndicator(),): Column(
                                    ...
                                    Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: MaterialButton(
                                          onPressed: () {
                                            showAcceptAlert(context,cartdata[i]['order_id']);
