                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        snapshot.data.date.user_id == userId
                            ? Center(
                                child: Container(
                                      ...
                                      Navigator.push(context,
                                        ...
                                        return SellBook(
                                            bookId: snapshot
                                                ...
                                                .toString(),
                                            desc: snapshot.data.date.description
                                                .toString(),
                                            sem: snapshot.data.date.semester
                                                .toString(),
                                            bookname: snapshot.data.date.name,
                                            authorname:
                                                snapshot.data.date.auther_name,
                                            price: snapshot.data.date.price
                                                .toString(),
                                            edition: snapshot
                                                .data.date.edition_detail,
                                            condition:
                                                snapshot.data.date.conditions,
                                            name: "Edit");
                                      }));
