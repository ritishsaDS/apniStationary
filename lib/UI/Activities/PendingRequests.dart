  ...
  void getOrderRequests() async {
    ...
    try {
      final response = await post(
          Uri.parse("https://admin.apnistationary.com/api/list-order-requests"),
          body: ({
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => RequestDetail(
                                  ...
                                  college_name: cartdata[i]['college_name'])));
                    },
                    child: Container(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    rs +
                                        " " +
                                        cartdata[i]['pay_amount'].toString(),
                                    style: TextStyle(
      ...
      if (response.statusCode == 256) {
        ...
        if (responseJson['status'] == "200") {
          ...
          AppNotificationHandler.sendMessage(
              msg: PreferenceManager.getName() + " Accepted Your Order",
              data: body,
              token: firebasid.toString().split(",")[1].toString());
      ...
      if (response.statusCode == 256) {
        ...
        if (responseJson['status'] == "200") {
          setState(() {
            ...
            AppNotificationHandler.sendMessage(
                msg: PreferenceManager.getName() + " Rejected Your Order",
                data: body,
                token: firebasid.toString().split(",")[1].toString());
