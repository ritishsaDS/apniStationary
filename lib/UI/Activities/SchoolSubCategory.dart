...
class SchoolSubCategory extends StatefulWidget {
  String id;
  dynamic text;
  SchoolSubCategory({this.text,this.id});

  @override
  _SchoolSubCategoryState createState() => _SchoolSubCategoryState();
}

class _SchoolSubCategoryState extends State<SchoolSubCategory> {
                    ...
                    return InkWell(
                      onTap: (){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context){
                          return SubCategory(img: assetImages[0],text: widget.text[index],);
                        }));
                      },
                      child: Container(
                        child: Column(
