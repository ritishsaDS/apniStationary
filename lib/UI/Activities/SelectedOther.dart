...
class SelectedOther extends StatefulWidget {
  const SelectedOther({Key key}) : super(key: key);

  @override
  _SelectedOtherState createState() => _SelectedOtherState();
}
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(15),
                            child: Image.asset('assets/icons/mgt.png',
                              fit: BoxFit.cover,),
                          ),
                        ),
                        Container(
